...
public class ArrowScript : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D target)
    {
        ...
        if(target.tag == "TopBrick" || target.tag == "UnbreakableBrickTop" ||
           target.tag == "UnbreakableBrickBottom" || target.tag == "UnbreakableBrickLeft" ||
           target.tag == "UnbreakableBrickRight" || target.tag == "UnbreakableBrickBottomVertical")
        {
            ...
            else if (this.gameObject.tag == "FirstStickyArrow")
            {
                ...
                else if(target.tag == "UnbreakableBrickTop" ||
                        target.tag == "UnbreakableBrickBottom" || 
                        target.tag == "UnbreakableBrickLeft" ||
